...
const OurApproach = () => {
    return (
        <section className='bg-black flex flex-col mx-auto pb-10 '>
            <div className='w-[50%] pb-8 '>
                <h1 class="mb-4 text-3xl w-[700px] font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-primary-500">Sales </span> Growth Acceleration  <span class="text-primary-500">Hub</span> </h1>
                <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Strategic Collaboration for Sustainable Growth: Your Trusted Business Development Partner, Committed to Crafting Tailored Solutions and Driving Long-term Success Together.</p>
            </div>


            <div class="max-w-full flex   bg-gray-900  rounded-3xl  ">
                <div className='flex flex-col w-[50%] py-6 pb-16 px-16 mr-[20px] '>
                    <div className='bg-primary-500 p-3 rounded-full justify-center w-[80px] flex items-center my-7'>
                        <svg className='w-[50px] fill-white' viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
            ...
            <div className='flex gap-7 mt-7'>
                ...
                <Image src={"/img1.png"} alt='img' width={700} height={100} class="rounded-3xl h-[350px] " />
                    ...
                    <div class="px-16 py-10">
                        ...
                        <h5 class="mb-2 text-[35px] font-extrabold tracking-tight text-[#602606]">Crafting Pathways to Success</h5>

                        <p class="mb-3 font-normal text-black">At Kreanto, we take pride in our capacity to conceive groundbreaking strategies that surpass conventional boundaries, positioning our clients for sustained success in the ever-evolving design realm. </p>
