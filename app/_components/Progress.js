...
const Progress = () => {
    return (
        <>
        <section className='pt-20  bg-gray-900 rounded-3xl flex flex-col items-center'>
            <div className='  flex px-10 hover:scale-90 transition '>
                <a href="#" class="inline-flex justify-between items-center py-2 px-6 mb-7  rounded-full bg-[#0c0e2a]" role="alert">
                    <svg className='w-[30px] mr-2 fill-primary-500' viewBox="0 0 52 52" >
	...
	c-2.2,0-4-1.8-4-4s1.8-4,4-4s4,1.8,4,4S40.2,30,38,30z"/>
                    ...
                    <span class="text-base font-medium text-primary-500">Have Questions?</span>
            ...
            <div className='w-full py-16 md:mx-auto rounded-3xl mt-20 bg-[#0c0e2a] flex justify-between px-20 leading-8'>
