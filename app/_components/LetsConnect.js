        ...
        <section className='mt-40 '>
            ...
            <div className='flex flex-col gap-4 w-full'>
                ...
                <div className='flex gap-5 '>
                    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 w-[40%] rounded-3xl bg-[#0e1332]">
                        <div className="mx-auto ml-4 max-w-lg ">
