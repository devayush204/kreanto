...
const Faq = () => {
    return (
        <section className='mt-40 px-60'>
            <div className=' w-full flex flex-col  items-center'>
                <div className='text-center '>
                    <h1 class="mb-4 text-3xl w-[550px] font-extrabold text-white md:text-5xl lg:text-6xl ">Frequently Asked </h1>
                    <h1 class="mb-4 text-3xl w-[550px] font-extrabold  text-white md:text-5xl lg:text-6xl"><span class="text-primary-500">Questions </span>
                    </h1>
                </div>
                <p class="text-lg font-normal text-center text-gray-500 lg:text-xl mb-16 w-[530px]">We address common queries, demystify intricacies, and provide insights to guide you through our services.</p>
            </div>
